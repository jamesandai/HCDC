...
class ALGORITHM:
    ...
    # fileurl = 'C://Users//james//Desktop//两个算法//2//ED'
    # filename = '../../datasets/VDD2.txt'
    # filename = '../../datasets/jain.txt'

    # fileurl = 'C://Users//james//Desktop//两个算法//2//VDD_Heartshaped'

    # filename = '../../datasets/Aggregation/dataset.csv'
    # fileurl = 'C://Users//james//Desktop//两个算法//2//Aggregation'
    #
    # filename = '../../datasets/Compound/dataset.csv'
    # fileurl = 'C://Users//james//Desktop//两个算法//2//Compound'

    # filename = '../../datasets/G50/dataset.csv'
    #
    # filename = "../../datasets/ThreeCircles.txt"#0.05
    # fileurl = 'C://Users//james//Desktop//两个算法//2//ThreeCircles'

    # filename = "../../datasets/R15.txt"#0.1
    # fileurl = 'C://Users//james//Desktop//两个算法//2//R15'

    # filename = "../../datasets/mypoint.txt"
    # fileurl = 'C://Users//james//Desktop//两个算法//2//mypoints'

    # filename = "../../datasets/point.txt"
    # fileurl = "C://Users//james//Desktop//两个算法//2//points"
    ...
    def RunAlgorithm(self):
        ...
        Rep,cores,Contain_point = self.get_Rep_and_core2(KNN, Den,NN,dis,points)
        #
    ...
    #CASE_CORE 2
    def get_Rep_and_core2(self,KNN,Den,NN,dis,points):
        size = len(Den)
            ...
            for j in s:
                ...
                if num > max_rep_count:
                    ...
                    if dis[i,j] * np.abs(Den[i] - Den[j])  < dis[i,max_rep] * np.abs(Den[i] - Den[max_rep]):
                        ...
                        max_rep_count = num
            Rep[i] = max_rep
        # self.pf.print_Rep_line(points, Rep)
                    ...
                    if j in delete_cores:
                        ...
                        if j in NND_childs[d[i]] or i in NND_childs[d[j]]:
                                ...
                                if Den[i] > Den[j]:
                                    ...
                                    continue
        # self.pf.print_Dcores_line_step2(points, cores, NND_childs)
        Contain_point = []
        for i in range(len(cores)):
